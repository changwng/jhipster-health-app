...
@RestController
@RequestMapping("/api/jhipster-health-kafka")
public class JhipsterHealthKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterHealthKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterHealthKafkaResource(KafkaProperties kafkaProperties) {
