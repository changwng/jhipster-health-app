package com.lemon.hgod.web.rest;
...
import com.lemon.hgod.config.KafkaProperties;
...
class JhipsterHealthKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterHealthKafkaResource kafkaResource = new JhipsterHealthKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-health-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-health-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
